<aside id="logo-sidebar" 
  ...
  <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
    <ul class="space-y-2 font-medium">
      ...
      {{-- Dashboard --}}
      <x-flowbitenav.sidelink href="/admin/dashboard" :active="request()->is('/admin/dashboard')">
        <x-slot name="icon">
        ...
        Dashboard
      </x-flowbitenav.sidelink>

      {{-- Students --}}
      <x-flowbitenav.sidelink href="/admin/student" :active="request()->is('/admin/student')">
        <x-slot name="icon">
      ...
      {{-- Teachers --}}
      <x-flowbitenav.sidelink href="/admin/teacher" :active="request()->is('')">
        <x-slot name="icon">
          <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 
              group-hover:text-gray-900 dark:group-hover:text-white" 
              aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" 
      ...
      {{-- Classrooms --}}
      <x-flowbitenav.sidelink href="/admin/classroom" :active="request()->is('')">
        <x-slot name="icon">
          <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 
              group-hover:text-gray-900 dark:group-hover:text-white" 
              aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" 
      ...
      {{-- Subjects --}}
      <x-flowbitenav.sidelink href="/admin/subject" :active="request()->is('')">
        <x-slot name="icon">
          <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 
              group-hover:text-gray-900 dark:group-hover:text-white" 
              aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" 
      ...
      {{-- Guardians --}}
      <x-flowbitenav.sidelink href="/admin/guardian" :active="request()->is('')">
        <x-slot name="icon">
          <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 
              group-hover:text-gray-900 dark:group-hover:text-white" 
              aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" 
      ...
      {{-- Logout --}}
      <x-flowbitenav.sidelink href="/dashboard" :active="request()->is('/dashboard')">
        <x-slot name="icon">
          <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 
              group-hover:text-gray-900 dark:group-hover:text-white" 
              aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" 
